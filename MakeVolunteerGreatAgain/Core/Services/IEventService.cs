...
public interface IEventService
{
    ...
    Task<UpdateEventDTO> UpdateEventAsync(UpdateEventDTO updatedEvent, int id, int organizationCommonUserId);
    Task<bool> DeleteEventAsync(int id, int organizationCommonUserId);
