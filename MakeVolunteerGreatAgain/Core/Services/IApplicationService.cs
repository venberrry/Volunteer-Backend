...
public interface IApplicationService
{
    ...
    Task<IEnumerable<Application>?> GetApplicationsByEventIdAsync(int eventId, int organizationCommonUserId);
    Task<IEnumerable<Application>?> GetAcceptedApplicationsByEventIdAsync(int eventId, int organizationCommonUserId);
