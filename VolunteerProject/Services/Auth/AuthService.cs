...
namespace VolunteerProject.Services.Auth;
public class AuthService : IAuthService
{
    ...
    public AuthService(UserManager<Volunteer> volunteerManager, UserManager<Organization> organizationManager,
    ...
    public async Task<AuthResult> LoginAsync(LoginModel model)
    {
        ...
        if (user.UserName == null || model.Password == null)
        {
            return new AuthResult
                { Success = false, Errors = new List<string> { "Email or Password does not exist." } };
        }
