...
namespace VolunteerProject.Migrations
{
    ...
    [Migration("20240613142224_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("VolunteerProject.Models.Organization", b =>
                {
                    ...
                    NpgsqlPropertyBuilderExtensions.UseIdentityByDefaultColumn(b.Property<int>("IdO"));
            ...
            modelBuilder.Entity("VolunteerProject.Models.Volunteer", b =>
                {
                    ...
                    NpgsqlPropertyBuilderExtensions.UseIdentityByDefaultColumn(b.Property<int>("IdV"));
            ...
            modelBuilder.Entity("VolunteerProject.Models.Organization", b =>
                {
                    b.HasOne("VolunteerProject.Models.User", "User")
                        .WithOne()
                        .HasForeignKey("VolunteerProject.Models.Organization", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("VolunteerProject.Models.Volunteer", b =>
                {
                    b.HasOne("VolunteerProject.Models.User", "User")
                        .WithOne()
                        .HasForeignKey("VolunteerProject.Models.Volunteer", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
